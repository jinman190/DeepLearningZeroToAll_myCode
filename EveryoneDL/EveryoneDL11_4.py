...
L4 = tf.nn.relu(ft.matmul(L3, W4) + b4)
L4 = tf.nn.dropout(L4, keep_prob=0.7) #dropout 확률


W5 = tf.get_variable("W4", shape=[4*4*128, 10], initializer=tf.contrib.layers.xavier_initializer())
